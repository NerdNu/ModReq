...
/**
 * Represents the in-game command /elevate.
...
public class ElevateCommand implements CommandHandler {
     ...
     */
    public ElevateCommand(ModReq plugin, UnclaimCommand unclaimCommand) {
        this.plugin = plugin;
    ...
    public boolean execute(Player player, String name, String[] args) {
        ...
        unclaimCommand.execute(player, name, args);
        ...
        getRequest(player, playerUUID, args[0], true, claimedIds, reqTable, environment,
            ...
            if (status == Request.RequestStatus.OPEN) {
                ...
                messageMods(configuration.MOD__FLAGGED, environment, configuration);
